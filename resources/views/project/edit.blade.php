  ...
  <ol class="breadcrumb">
    ...
    <div class="border border-1 rounded-1 p-3">
        {{ Form::model($project, array('route' => array('project.update', $project->id), 'method' => 'PUT')) }}
            <script> 
                 _start= "{{\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($project->start_date))}}";
                 _end= "{{\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($project->end_date_pre))}}";
             </script>
            <div class="row p-2">
                <div class="col-md-3">
                    <div class="row">
