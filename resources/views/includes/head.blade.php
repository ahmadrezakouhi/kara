...
<link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/css/bootstrap-select.css"/>

<link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/css/jquery-confirm.min.css" />
<link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/css/persian-datepicker.css" />
